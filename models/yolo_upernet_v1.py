#Yolo + UperNet V1!!! Check V2 cuz that's where the batchNorm edit to solve eval() is at!
...
#featuremapVisualization---------------ENDS
        ...
        for i in range(len(x)):
          ...
          #print("HELLO 18TH OCT 2021")
          #print(fusion_list[i].shape)
          #torch.Size([1, 192, 640, 640])
          #torch.Size([1, 384, 640, 640])
          #torch.Size([1, 768, 640, 640])
          
        fusion_out = torch.cat(fusion_list,1)
        #print("FUSION_OUT")
        #print(fusion_out.shape) #torch.Size([1, 1344, 640, 640])
        last = self.conv_last(fusion_out)
        #print(last[0][30]) #16th November 2021
#        print("LAST")
#        print(last[0][0])
...
#         def conv3x3_bn_relu(in_planes = 1344, out_planes = 256, stride=1):
#      "3x3 convolution + BN + relu"
...
#        
#        self.conv_last = nn.Sequential( conv3x3_bn_relu(1344, 256, 1), nn.Conv2d(256, 10, kernel_size=1))
